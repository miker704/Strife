...
### UI and Cosmetic Fixes and Changes
    ...
    - Created A new Version of editFriendship modal but for use in the Mega Upc modal which handles creating a message, deleting friend, blocking and unblocking a user, and copying the user id.
