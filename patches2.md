...
### UI and Cosmetic Fixes and Changes
    ...
    - Added a check to turn off blocked user snack bar within bloacked user snack bar to prevent the chance from it appearing in group dms and other dm chats where it the user is not blocked.
