...
const DMMessageEdit = ({
    ...
    const handleEdit = (e) => {
        ...
        if (value !== dmMessage.body) {
            ...
            console.log("editing message newly edited message is : ", value);
        }
        setShowDmEdit(false);
    };
    ...
    return (
        <li className="chat-message-item" key={dmMessage.id} ref={popUpRef}>
            ...
            <div className="message-wrapper-contents">
                ...
                <div className={`message-accessories-button-wrapper ${currentUserId === dmMessage.sender_id ? `` : `is-hidden`}`}>
