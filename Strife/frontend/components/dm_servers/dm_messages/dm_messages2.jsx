...
class DmMessages2 extends React.Component {
    constructor (props) {
        super(props);
        ...
        const handlers = {
            recieved (incomingDmMessages) {
                ...
                if (Object.values(incomingDmMessages).length > 1) {
                    if (this.state.dmMessagesIds.includes(incomingDmMessages.id.toString())) {
                        ...
                        this.setState({ ["DmMessages"]: this.state.DmMessages.concat([incomingDmMessages]) })
                        this.setState({ ["dmMessageIds"]: this.state.dmMessagesIds.concat(incomingDmMessages.id.toString()) })
                    }
    ...
    handleSubmit (e) {
        e.preventDefault();
        e.stopPropagation();
        // let dmMessagebody = this.state.value.slice(0, -1);
    ...
    render () {
        ...
        let dmMessageOLLIMapping = this.state.DmMessages.map((dmMessage) => {
            ...
            // const printDMMessage = dmMessage.body.includes('@') ? this.renderMessage(dmMessage.body): console.log("no");
            {
                return (
