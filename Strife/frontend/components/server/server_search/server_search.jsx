...
const ExploreServers = (props) => {
    ...
    console.log("server search props: ", props);
    console.log(props.unExploredServers);
    ...
    const unExploredServers = Object.values(props.unExploredServers).map((server) => {
        ...
        console.log("online members : ", onlineServerMembers.length);
                                                    ...
                                                    <div className="action-button-scroller">
                                                        <div role={"group"}>
                                                            <div className="action-button-pop-up-item">
                                                                <div className="action-button-strife-server-link">{server.invite_link}</div>
