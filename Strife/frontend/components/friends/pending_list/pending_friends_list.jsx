                                        ...
                                        return (
                                            <li className="friend-index-item" key={friend.id}>
                                                ...
                                                <div className="pending-request-actions">
                                                    ...
                                                    <div className="pending-check-icon green-button">
                                                ...
                                                294.401c-9.998 9.997-26.207 9.997-36.204-.001z">
                                                    ...
                                                    <div className="pending-deny-icon red-button">
                                            ...
                                            <li className="friend-index-item" key={friend.id}>
                                                ...
                                                <div className="pending-request-actions">
                                                    <div className="pending-deny-icon red-button">
                                                        ...
                                                        {/* <div  aria-describedby="cancel"  role={"tooltip"} className="pending-request-actions-tool-tip">Cancel</div> */}
