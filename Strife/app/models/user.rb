...
class User < ApplicationRecord
    ...
    validates :phone_number, format:{with: /\+\d{1}-\d{3}-\d{3}-\d{4}/, message: "Phone number is invalid, please confirm that it is correct."},
    length: {is: 15, message: "Phone Number is not of 9 digits long" }, uniqueness: true, allow_nil: true
