...
//             console.log("channel is does not belong to this server terminating modal  .........");
//             props.closeModal();
//         }
//         else{
//             console.log("channel does belong here");
//             props.fetchChannel(props.mod_Channel_ID).then(() => { }, (error) => { props.closeModal(); });
...
//     // useEffect(() => {
//     //     if (props.mod_Channel_ID === props.channel?.id) {
//     //         setChannel(props.channel);
//     //         setNewChannelName(props.channel.channel_name);
//     //         console.log('mooooo')
//     //     }
