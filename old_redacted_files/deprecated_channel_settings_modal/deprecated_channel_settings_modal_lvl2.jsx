//deprecated repplcaed by a version that implements a rescue with an animation.
...
//     console.log('CSM props : ');
//     console.log(props);

//     const[useThisChannel, setUseThisChannel] = useState(props.channel);
//     console.log("channelstAste : ");
//     console.log(useThisChannel);
//     useEffect(()=> {
//         console.log("inside fetch channel use effect");
