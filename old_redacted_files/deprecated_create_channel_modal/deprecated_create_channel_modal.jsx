// deprecated as certain vars are removed/ replaced 
...
//                     <path fill="rgb(128,132,142)" d="M5.13231 6.72963L6.7233
//                         5.13864L14.855 13.2704L13.264 14.8614L5.13231 6.72963Z">
//                     </path>
//                     <path fill="rgb(128,132,142)" d="M13.2704 5.13864L14.8614
...
//                                                 </h5>
//                                                 <div role={"radiogroup"}>
//                                                     <div className={`ccm-radio-item`} role={"radio"} aria-checked={`${selectedOption === 1 ? true : false}`}>
...
//                                                         </label>
//                                                     </div>
//                                                     <div className="ccm-radio-item" role={"radio"} data-tip data-for="voice-channel-Strife-access" aria-checked={`${selectedOption === 2 ? true : false}`}>
...
//                                                     {inner_input_icon}
//                                                     <input value={channelName} maxLength={100} spellCheck={false} onChange={(e) => setChannelName(e.currentTarget.value)} type="text" className="ccm-input-cn" placeholder="new-channel" />
//                                                 </div>
//                                                 {channelErrorsMsg}
//                                             </div>
...
//                                             {
//                                                 channelName.length === 0 ? (<button type="button" disabled className="ccm-submit-button">{`${selectPrivacy === false ? `Create Channel` : `Next`}`}</button>) :
//                                                     selectPrivacy === false ? (
//                                                         (<button type="submit" className="ccm-submit-button">{`Create Channel`}</button>)
//                                                     ) : (<button disabled type="button" className="ccm-submit-button">{`Next`}</button>)

//                                             }
//                                             <button type="submit" onClick={() => props.closeModal()} className="ccm-cancel-button">Cancel</button>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
