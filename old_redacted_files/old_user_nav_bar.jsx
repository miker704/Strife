...
/** 
 * // This is the old usernav bar replaced by the newer version that uses react hooks instead
 * and has a new styling importing old styling as well to consistently match discords version
 * the change to react hooks is due to the fact this component does not do much complex functionallity.
 * 
...
class UserNavBar extends React.Component {
  ...
  clickToMute () {
    if (this.state.micMute === false) {
      return "Mute";
    }
    else if (this.state.micMute === true) {
      return "Unmute";
    }
  }
  ...
  clickToDeafen () {
    ...
    else if (this.state.deafen === true) {
      return "Undeafen";
    }
  }
  ...
  render () {
    ...
    let mic_component = this.state.micMute === false ?
      (<svg onClick={() => this.setState({ micMute: true })} className="svg-microphone" width="20" height="20" viewBox="0 0 20 20">
        <path d="M14.99 11C14.99 12.66 13.66 14 12 14C10.34 
    ...
    16.1 12 16.1Z" fill="currentColor">
      ...
      (<svg onClick={() => this.setState({ micMute: false })} className="svg-muted-microphone" width="20" height="20" viewBox="0 0 20 20">
    ...
    let headphone_component = this.state.deafen === false ?
      (<svg onClick={() => this.setState({ deafen: true })} className="svg-headphone" width="20" height="20" viewBox="0 0 24 24">
        <svg width="24" height="24" viewBox="0 0 24 24"><path d="M12 2.00305C6.486 2.00305 2 6.48805 2 12.0031V20.0031C2 
    21.1071 2.895 22.0031 4 22.0031H6C7.104 22.0031 8 21.1071 8 20.0031V17.0031C8 15.8991 7.104 15.0031 6 15.0031H4V12.0031C4 
    7.59105 7.589 4.00305 12 4.00305C16.411 4.00305 20 7.59105 20 12.0031V15.0031H18C16.896 15.0031 16 15.8991 16 
    17.0031V20.0031C16 21.1071 16.896 22.0031 18 22.0031H20C21.104 22.0031 22 21.1071 22 20.0031V12.0031C22 6.48805 
    17.514 2.00305 12 2.00305Z" fill="currentColor">
        </path>
        </svg>
      </svg>) :
      (<svg onClick={() => this.setState({ deafen: false })} className="svg-muted-headphone" width="20" height="20" viewBox="0 0 24 24">
        <path d="M6.16204 15.0065C6.10859 15.0022 6.05455 15 6 15H4V12C4 7.588 7.589 4 12 4C13.4809 4 14.8691 4.40439 
      16.0599 5.10859L17.5102 3.65835C15.9292 2.61064 14.0346 2 12 2C6.486 2 2 6.485 2 12V19.1685L6.16204 15.0065Z"
          fill="currentColor"></path>
        <path d="M19.725 9.91686C19.9043 10.5813 20 11.2796 20 12V15H18C16.896 15 16 15.896 
      16 17V20C16 21.104 16.896 22 18 22H20C21.105 22 22 21.104 22 20V12C22 10.7075 21.7536 9.47149 21.3053 8.33658L19.725 9.91686Z"
          fill="currentColor">
        </path>
          ...
          <div className="contain-icon">
            ...
            <svg onClick={() => this.props.openModal('userProfile')} className="fa-gear" width="20" height="20" viewBox="0 0 24 24">
              <path fill="currentColor" d="M19.738 10H22V14H19.739C19.498 14.931 19.1 15.798 18.565 16.564L20 
                ...
                19.099 7.436 18.564L6 20L4 18L5.436 16.564C4.901 15.799 4.502 14.932 4.262 14H2V10H4.262C4.502 
                9.068 4.9 8.202 5.436 7.436L4 6L6 4L7.436 5.436C8.202 4.9 9.068 4.502 10 4.262V2H14V4.261C14.932
                 4.502 15.797 4.9 16.565 5.435L18 3.999L20 5.999L18.564 7.436C19.099 8.202 19.498 9.069 19.738 10ZM12 
