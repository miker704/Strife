...
// const ServerUserOptionsModal = (props) => {
...
//     let rendered_USER_AVATAR = member.photo === undefined ? (
...
//                                 {
//                                     props.serverType === 'SERVER' && props.currentUser.id !== props.ServerOwner ? (
//                                         <div className='upc-section-content'>
//                                             {
//                                                 rolesOrNoRolesRef.current > 0.5 ? (
//                                                     <>
...
//                                                                 </div>
//                                                                 <div className='upc-role-name-text-wrapper'>
//                                                                     <div className='upc-role-name-text'>Server Member</div>
//                                                                 </div>
//                                                             </div>
//                                                         </div>
//                                                     </>
...
//                                                     autoFocus={false} autoCorrect='off' autoComplete='off' value={message}
//                                                     onChange={(e) => setMessage(e.currentTarget.value)}
//                                                     placeholder={`You cannot message blocked users`} disabled readOnly={true} />
//                                             </div>
//                                         </div>
//                                         <div className='upc-section-content-sep'></div>
//                                     </div>
...
//                 <div className='upc-popout' ref={popupRef} onClick={(e) => e.stopPropagation()} style={{ top: `${rePositionTop * 0.60}px` }}>
//                     {serverUserOptionsContent}
//                 </div>
