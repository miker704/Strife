...
// const ServerUserOptionsModal1 = (props) => {
...
//             console.log("documentHiehgt:", documentHeight);
//             console.log("prevheight : ", previewHeight);
...
//                 style={{
//                     top: (rePositionTop * 0.6), right: `${props.messageVersion ? `unset` : `247.909px`}`,
//                     left: `${props.messageVersion && props.userNameClicked ? `${props.getClientRect.width + props.getClientRect.left}px`
...
//     let posStyle = {
//         "0": { position: `absolute`, right: `247.909px`, top: `${rePositionTop * 0.60}px` },
//         "1": { position: `absolute`, top: `${rePositionTop * 0.60}px`, left: `` },
//     }
...
//                 {/* <div id="upc-mod" className={`${props.messageVersion ? `upc-popout message-version` : `upc-popout`}`} ref={popupRef} onClick={(e) => e.stopPropagation()}
//                     style={{ top: `${rePositionTop * 0.60}px`, right: `${props.messageVersion ? `unset` : `247.909px`}`, left: `${props.messageVersion ? `376px` : ``}` }}> */}
//                 {/* <div id="upc-mod" className={`${props.messageVersion ? `upc-popout message-version` : `upc-popout`}`} ref={popupRef} onClick={(e) => e.stopPropagation()}
//                     style={{ top: (maxTop ? Math.min(rePositionTop, maxTop) : rePositionTop), right: `${props.messageVersion ? `unset` : `247.909px`}`, left: `${props.messageVersion ? `376px` : ``}` }}> */}
...
// export default ServerUserOptionsModal1; 
