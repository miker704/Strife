//this is using unset for the right style when using messages 
// to use go to styles and change to this
/**
 * .upc-popout {
  position: absolute;
  pointer-events: auto;
...
//                 style={{
//                     top: props.messageVersion ? (maxTop ? Math.min(rePositionTop, maxTop) : rePositionTop) : (rePositionTop * 0.60), right: `${props.messageVersion ? `unset` : `247.909px`}`,
...
//                     <div id="upc-mod" className={`${props.messageVersion ? `upc-popout message-version` : `upc-popout`}`} ref={popupRef} onClick={(e) => e.stopPropagation()}
//                         style={{
//                             top: (rePositionTop * 0.60), right: `${props.messageVersion ? `unset` : `247.909px`}`,
//                             left: `${props.messageVersion && props.userNameClicked ? `${props.getClientRect.width + props.getClientRect.left}px`
//                                 : props.messageVersion ? `376px` : ``}`
//                         }}>
//                         <div className={`upc-inner-wrapper ${props.messageVersion ? `reverse-animation` : ``}`}>
