//merged both suop modal and suop messenger modal with travel
...
// const ServerUserOptionsModalK10 = (props) => {
...
//         if (maxTop) {
//             setTimeout(() => {
//                 getMod.style.transition = "top 0.3s ease-in-out 0s";
//             }, 100);
...
//                 style={{
//                     top: props.messageVersion ? (maxTop ? Math.min(rePositionTop, maxTop) : rePositionTop) : (maxTop ? Math.min(rePositionTop, maxTop) : rePositionTop * 0.6), right: `${props.messageVersion ? `` : `247.909px`}`,
...
//                     <div id="upc-mod" className={`${props.messageVersion ? `upc-popout message-version` : `upc-popout`}`} ref={popupRef} onClick={(e) => e.stopPropagation()}
//                         style={{
//                             top: props.messageVersion ? (rePositionTop * 0.60) : (maxTop ? Math.min(rePositionTop, maxTop) : rePositionTop * 0.60), right: `${props.messageVersion ? `` : `247.909px`}`,
//                             left: `${props.messageVersion && props.userNameClicked ? `${props.getClientRect.width + props.getClientRect.left}px`
//                                 : props.messageVersion ? `376px` : ``}`
//                         }}>
//                         <div className={`upc-inner-wrapper ${props.messageVersion ? `reverse-animation` : ``}`}>
...
// export default ServerUserOptionsModalK10; 
