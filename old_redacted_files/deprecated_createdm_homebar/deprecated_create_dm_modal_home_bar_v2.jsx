// this uses a fetch without disrupting state
...
// const CreateDmModalHomeBar = (props) => {
...
//         // props.requestAllFriendships().then(() => {
//         //     setFriends(props.friends);
//         //     setIsLoading(false);
...
//         )
//     }
//     else if (isLoading === false && friends.length > 0) {
//         return (
//             <div className={`clear-modal-wrapper homeBar`} onClick={(e) => props.closeModal()}>
//                 <div className="create-dm-modal-popup" onClick={e => e.stopPropagation()} ref={popupRef}>
//                     {/* <div className="create-dm-modal-popup" onClick={e => e.stopPropagation()} ref={popupRef} style={{ top: `${popUpTop}px` }}> */}
