//deprecated as of june 4th 2022 as discord has since updated to remove @ and group chat icon svgs
// with actual images and allows for editing of group names regardless of 1 to 1 chat or group chats with
// members > 2. Also this component uses is-hidden incorrectly and does not condtionally render correctly
// online status bubbles have also been removed from discord for one to one chats as profile avatars with
// online status has been added.
