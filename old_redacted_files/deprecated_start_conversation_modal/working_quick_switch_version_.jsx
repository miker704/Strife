// working version of quick switch put performance issues exist. so the old version of the search is still
// used
...
//     const [dmServers, setDmServers] = useState(props.dmServers);
...
//     //             result = result.map((friend, idx) => { friend.TYPE = "FRIEND"; return friend; })
//     //             setFriends(result);
//     //         }, (error) => {
//     //             props.closeModal();
//     //         })

//     //     fetchServers(props.currentUser.id).then((result) => {
//     //         let serversMap = Object.values(result).map((server, idx) => { server.TYPE = "SERVER"; server.username = server.server_name; return server; });

//     //         let channelsMap = Object.values(result).map((server, idx) => {
...
//     //                 channel.TYPE = channel.channel_type === 1 ? "TEXT_CHANNEL" : "VOICE_CHANNEL";
//     //             }
//     //             return Object.values(server.channels);
//     //         }).flat(Infinity);

//     //         let voiceChannelsMap = channelsMap.filter((channel) => channel.channel_type === 2);
//     //         let textChannelsMap = channelsMap.filter((channel) => channel.channel_type === 1);
//     //         setServers(serversMap);
//     //         setVoiceChannels(voiceChannelsMap);
//     //         setTextChannels(textChannelsMap);


//     //     }, (error) => {
//     //         props.closeModal();
//     //     })
//     //     fetchDmServers(props.currentUser.id).then((result) => {

//     //         let dmServerMap = Object.values(result).map((dmServer) => {
...
//     //             return dmServer;
//     //         });
//     //         setDmServers(dmServerMap);
//     //         setIsLoading(false);
//     //     }, (error) => { props.closeModal(); })
...
//     // console.log(`friends async = ${friends}`);
//     // console.table(friends);
//     // console.log(`servers async = ${servers}`);
//     // console.table(servers);
//     // console.log(`voicechannels async = ${voiceChannels}`);
//     // console.table(voiceChannels);
//     // console.log(`textchannels async = ${textChannels}`);
//     // console.table(textChannels);
//     // console.log(`dmservers async = ${dmServers}`);
//     // console.table(dmServers);
...
//     //         return server;
//     //     })
//     //     let channelMapper = extractServers.map((server, idx) => {
//     //         for (let channel of Object.values(server.channels)) {
//     //             channel.server_name = server.server_name;
//     //             channel.username = channel.channel_name;
...
//     //     const voiceChannelsArray = channelMapper.filter((channel, idx) => {
//     //         return channel.channel_type === 2;
//     //     })
//     //     const textChannelsArray = channelMapper.filter((channel, idx) => {
...
//     //         return dmServer;
//     //     })
//     //     setVoiceChannels(voiceChannelsArray);
//     //     setTextChannels(textChannelsArray);
//     //     setServers(extractServers);
//     //     setDmServers(extractDmServers);
//     //     setFriends(props.friends);
//     //     setTimeout(() => {
//     //         setIsLoading(false);
//     //     }, 500);
//     // }, [props.friends.length, props.servers.length, props.dmServers.length]);
...
//     let combinedState = [...extractServers, ...textChannelsArray, ...voiceChannelsArray, ...extractDmServers, ...extractFriends];
...
//                                         {/* 
//                                         {
//                                             _liveSearch(combinedState).filter((item) => { item.TYPE === "SERVER"; return item; }).map((server, idx) => {
...
//                                                 return (
//                                                     <div className="result-item"
//                                                         id={`uid_100 item-${server.id}`} role={'option'} key={`server-${server.id}`}>
//                                                         <Link to={`/$/channels/${server.id}/${server.general_channel_id}`} style={{ textDecoration: `none` }}
//                                                             onClick={() => props.closeModal()}>
//                                                             <div className="result-item-inner">
//                                                                 <div className="result-item-server-guild-card-container">
