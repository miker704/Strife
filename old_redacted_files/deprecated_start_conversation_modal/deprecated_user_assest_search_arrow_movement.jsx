...
const StartConversationSearchBarModal = (props) => {
    ...
    useEffect(() => {
        if (searchText.length === 0) {
            ...
            // console.log("search text > 0");
            console.log("y_cord reset  0");
    ...
    useEffect(() => {
        if (searchText === 0) {
            ...
            console.log(`y_Coord Warp === ${y_Coord} potential false`);
            // setPotentialResult(false);
    ...
    const liveSearch = () => {
        ...
        if (count === allItems.length) {
            ...
            if (search_query.length > 0) {
                console.log('search not and not null empty')
                setYCoord(99.99);
                setPotentialResult(true);
            }
                    ...
                    <div className="uas-modal-container" onClick={(e) => e.stopPropagation()}>
                        <div className="uas-modal">
                            ...
                            <div className="uasm-scroller auto-scroll-raw-attributes global-scroller-base" style={{ overflow: `hidden scroll`, paddingRight: `0px` }}
                                // onMouseEnter={(e) => { if (searchText.length > 0 && potentialResult === true) { setMouseOverScroll(true); } }}
                                // onMouseLeave={(e) => { setMouseOverScroll(false); }}
                                onMouseOver={(e) => {
                                    // if (mouseOverScroll === true) {
                                    if (potentialResult === true && searchText.length > 0) {
                            ...
                            <div className={`uas-tutorial show-tutorial ${searchText.length === 0 ? `` : `has-query`}`}>
                                ...
                                <div className="arrowGroup-1">
                                    {/* <div id="arrow-horz-1" className="arrowGroup-container horz-arrows" style={{ transform: `${potentialResult === true && searchText.length > 0 ? `translateY(${y_Coord}px) translateZ(0px)` : `translateY(0px) translateZ(0px)`}` }}> */}
                                ...
                                <div className="arrowGroup-1 right-arrow-group">
                                    {/* <div id="arrow-horz-2" className="arrowGroup-container horz-arrows" style={{ transform: `${potentialResult === true && searchText.length > 0 ? `translateY(${y_Coord}px) translateZ(0px)` : `translateY(0px) translateZ(0px)`}` }}> */}
