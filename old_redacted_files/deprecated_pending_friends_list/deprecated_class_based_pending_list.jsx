//class based component replaced with functional component.
...
//                                                                             <img className={`friend-avatar-pfp color-${friend.color_tag}`} src={rendered_Default_PFP} alt="FAPFP" aria-hidden="true" />

//                                                                         ) : (
//                                                                             <img className={`friend-avatar-pfp`} src={friend.photo} alt="FAPFP" aria-hidden="true" />
//                                                                         )
//                                                                     }
//                                                                 </div>
//                                                             </foreignObject>
...
//                                                     <svg className="friend-check-mark-svg-icon" onClick={() => this.updateFriendShip(friend)} aria-hidden="true" role="img" width="24" height="24" viewBox="0 0 24 24">
...
//                                                     <svg onClick={() => this.deleteFriendShip(friend)} className="friend-x-svg-icon" aria-hidden="true" role="img" width="24" height="24" viewBox="0 0 24 24">
//                                                         <path fill="currentColor" d="M18.4 4L12 10.4L5.6 4L4 5.6L10.4 12L4 18.4L5.6 20L12 13.6L18.4 20L20 18.4L13.6 12L20 5.6L18.4 4Z">
//                                                         </path>
//                                                     </svg>
