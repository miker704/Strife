/*
The following file is a optimized version of the old Server User Options Modal
also known as UPC (User profile card) it allows rendering of both the 
user options and message area through the switch case preventing any attempts
to activate or use any pre-rendered options the appear from the generic layout that
renders for the first second before rendering the proper layout, hence preventing 
errors from activating an option that is not allow for that user to begin with.
This method will be used in case the newest method is two taxing on performance the newer
method renders the whole UPC through a switch instantly with no initial rendering of the 
generic UPC. 
*/
...
//         case -2:
//             //current user is blocked -> no message, only block option
//             EditOptions = (
//                 <>
...
// export default ServerUserOptionsModal2;
