...
//                                         {
//                                             _SHIFT === true ? (
//                                                 <div className="message-accessories-button" data-msg-control="1" data-tooltip-id="msg-control"
...
//                                         {
//                                             _SHIFT === true ? (
//                                                 <div className="message-accessories-button" data-msg-control="1" data-tooltip-id="msg-control" data-tooltip-place="top"
//                                                     data-tooltip-content={'Copy Link'} onMouseEnter={(e) => { e.stopPropagation(); setHover(true); }}
//                                                     onMouseLeave={(e) => { e.stopPropagation(); setHover(false); }}>
...
//                                         {
//                                             _SHIFT === true ? (
//                                                 <div className="message-accessories-button" data-msg-control="1" data-tooltip-id="msg-control" data-tooltip-place="top" data-tooltip-content={'Mark Unread'} onMouseEnter={(e) => { e.stopPropagation(); setHover(true); }}
//                                                     onMouseLeave={(e) => { e.stopPropagation(); setHover(false); }}>
...
//                                         {
//                                             _SHIFT === true ? (
//                                                 <div className="message-accessories-button" data-msg-control="1" data-tooltip-id="msg-control" data-tooltip-place="top" data-tooltip-content={'Pin Message'} onMouseEnter={(e) => { e.stopPropagation(); setHover(true); }}
//                                                     onMouseLeave={(e) => { e.stopPropagation(); setHover(false); }}>
...
//                                         {
//                                             _SHIFT === true ? (
//                                                 <div className="message-accessories-button" data-msg-control="1" data-tooltip-id="msg-control" data-tooltip-place="top" data-tooltip-content={'Reply'} onMouseEnter={(e) => { e.stopPropagation(); setHover(true); }}
//                                                     onMouseLeave={(e) => { e.stopPropagation(); setHover(false); }}>
...
//                                         <div className="message-accessories-button" data-msg-control="1" data-tooltip-id="msg-control" data-tooltip-place="top" data-tooltip-content={'Add Reaction'} onMouseEnter={(e) => { e.stopPropagation(); setHover(true); }}
//                                             onMouseLeave={(e) => { e.stopPropagation(); setHover(false); }}>
//                                             <AddReactionIcon className="add-reaction-icon" width={18} height={18} />
//                                         </div>

//                                         <div className="message-accessories-button" data-msg-control="2" data-tooltip-id="msg-control" data-tooltip-place="top" data-tooltip-content={"Add Super Reaction"}
//                                             onMouseEnter={(e) => { e.stopPropagation(); setHover(true); }}
//                                             onMouseLeave={(e) => { e.stopPropagation(); setHover(false); }}>
