// This is deprecated as it is unsafe for production it allows users to expolit the html to 
//view the hidden options which can crash the app on the users side.
// replaced by a superior condtional rendering method.
...
//                                     </div>
//                                 </div>
//                                 <div className={`channel-drop-item ${props.currentUser.id === serverOwnerId ? "" : "is-hidden"}`}
//                                     onClick={() => {
