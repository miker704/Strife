//deprecated replacedd with functional component
...
//         this.showUpdateProbability = this.showUpdateProbability.bind(this);
//         this.handleRemoveUpdateIcon = this.handleRemoveUpdateIcon.bind(this);
...
//         probability === true ? this.setState({ showUpdate: true }) : this.setState({ showUpdate: false });
//     }


//     handleRemoveUpdateIcon (e) {
//         e.preventDefault();
...
//             return (
//                 <FriendShipIndexContainer switchToAddFriendsPage = {this.handleClick}/>
//             )
//         }
//     }
...
//                                  onClick={() => this.props.openModal('createDmModalHomeBar')}
//                                 // onClick={() => this.setShowPopUp()}
//                                 >
...
//                             {
//                                 this.state.showUpdate && (<div className="update-ready-tool-bar" onClick={(e) => this.handleRemoveUpdateIcon(e)}>
