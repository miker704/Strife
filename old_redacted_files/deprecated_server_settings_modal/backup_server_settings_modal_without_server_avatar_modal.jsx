...
//             window.removeEventListener('keyup', overrideCloseModal, false);
//             return (
//                 <DeleteServerModalContainer closeSubMod={closeForm} formName={"deleteServer"} />
//             )
//         }
//     }
...
//                                                             // style={{ backgroundImage: `${serverIconPhotoUrl === undefined || serverIconPhotoUrl === '' ? `none` : `url(${serverIconPhotoUrl})`}` }}
