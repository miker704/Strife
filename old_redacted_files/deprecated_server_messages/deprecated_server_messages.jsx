...
//                 // console.log(`mousing over element with id of ${message.id}`);
...
//                     {/* {
//                         messageAuthor.photo === undefined ? (
//                             <img className={`chat-member-avatar-img color-${messageAuthor.color_tag}`} src={rendered_Default_PFP} alt=" " />
//                         ) : (
//                             <img className="chat-member-avatar-img" src={messageAuthor.photo} alt=" " />
//                         )
//                     } */}
//                     {
//                         messageAuthor.photo === undefined ? (
//                             <img className={`chat-member-avatar-img color-${messageAuthor.color_tag}`} src={DefaultPFPSVG3} alt=" " />
//                         ) : (
//                             <img className="chat-member-avatar-img" src={messageAuthor.photo} alt=" " />
//                         )
//                     }
...
//                             ? render_User_PFP : messageAuthor.photo}`} alt=" " />
//                     </div> */}
...
//             </div>
//             {/* <ReactTooltip
//                 className="msg-icon-thread-tool-tip"
//                 id="copyMsgID"
//                 place="top"
//                 effect="solid">
//                 Copy Message ID
...
//             {/* <ReactTooltip
//                 className="msg-icon-thread-tool-tip"
//                 id="edit-msg-create-thread"
//                 place="top"
//                 effect="solid">
//                 Create Thread
//             </ReactTooltip>
//             <ReactTooltip
//                 className="msg-icon-more-options-thread-tool-tip"
//                 id="edit-msg-more-options"
//                 place="top"
//                 effect="solid">
//                 More (Hold Shift)
//             </ReactTooltip> */}
