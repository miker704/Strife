...
//                 console.log("%c prevprops 5 this.props.fetchDmServer(this.props.dmServerId).then(() => {", "color#:FF0000")
//                 this.setState({ renderSkeleton: false });
//                 this.scrollToBottomOfChat("instant");
...
//                                         <MessageSkeletonList listNumber={10} />
//                                     ) : (
//                                         <React.Fragment>
//                                             <DmChatFirstMessageContainer renderBlockedUserSnackBarContainer={this.renderBlockedUserSnackBarContainer} dmServer={this.props.dmServer} dmServerMembers={this.props.dmServerMembers} setLoadingMessages={this.props.setLoadingMessages} loadingMessages={this.props.loadingMessages} />
...
//                                 {dmMessageOLLIMapping}
//                                 <div className="ol-scroller-spacer" ref={this.oLLSpacerRef} />
//                             </ol>
//                         </div>
//                     </div>
//                 </div>
