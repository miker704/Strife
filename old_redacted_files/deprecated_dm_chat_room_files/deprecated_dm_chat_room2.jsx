...
//         this.checkToDisableDmChatTA = this.checkToDisableDmChatTA.bind(this);
...
//         if (prevProps.DmMessages[0] !== this.props.DmMessages[0] || prevState.DmMessages.length < this.state.DmMessages.length) {
...
//             this.setState({ renderSkeleton: true });
...
//     checkToDisableDmChatTA = () => {
//         let blockedStatuses = [-2, -1];
//         if (this.props.dmServer?.one_to_one_dm === true) {
//             if (blockedStatuses.includes(this.props.dmServer.other_o2o_member.friend_request_status) === true) {
//                 return true;
//             }
//             else {
//                 return false;
...
//                                 scrollToBottomOfChat={this.scrollToBottomOfChat} checkToDisableDmChatTA={this.checkToDisableDmChatTA}
