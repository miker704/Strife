...
//                 received: ({ dm_message, head, path, dm_server, dm_member, type, }) => {
//                     console.log(`%c INCOMING DATA after : `, "color:#05dc28", dm_message, head, path, dm_server, dm_member, type);
...
//                     //         }
//                     //         else {
//                     //             console.log(`%c INCOMING DM_SERVER MESSAGE after : `, "color:#05dc28", dm_message);
...
//                     //             console.log(`%c INCOMING DM_SERVER MESSAGE alter author is : `, "color:#05dc28", dm_message.authorName);

//                     //             //rename it so that it can be editable
//                     //             dm_message.sender_id = dm_message.sender_id;
//                     //             console.log(`%c INCOMING DM_SERVER MESSAGE alter authorid is : `, "color:#05dc28", dm_message.sender_id);
...
//         // this.props.createDmMessage(this.state.newDmMessage).then(() => {
//         //     modedMessage.body = ''
...
//     // renderBlockedUserSnackBarContainer = (memberHash) => {
//     //     console.log("%c running check to disable", "color:#FF0000");
//     //     let blockedStatuses = [-2, -1];
//     //     if (this.props.dmServer?.one_to_one_dm === true) {
//     //         fetchUser(memberHash?.id).then((result)=>{
//     //             if(blockedStatuses.includes(result.friend_request_status)===true){
//     //                 console.log("%c user has been blocked disabling", "color:#FF0000");
//     //                 this.setState({ renderBlockedUserSnackBar: true });
//     //             }
//     //             else{
//     //                 console.log(`%c user is not blocked keeping chat open `, "color:#05dc28");
//     //                 this.setState({ renderBlockedUserSnackBar: false });
//     //             }
//     //         })
//     //     }
//     //     console.log(`%c user is not blocked keeping chat open `, "color:#05dc28");
...
//                                 scrollToBottomOfChat={this.scrollToBottomOfChat} checkToDisable={this.checkToDisable}
...
//                                 msgUpc={this.props.msgUpc} setMsgCtrlTTHover={this.props.setMsgCtrlTTHover} dmChannelMessages={this.state.DmMessages} setMsgCtrlSRTTHover={this.props.setMsgCtrlSRTTHover}
//                             /> */}
...
//                 </form>
//                 {/* {
//                     this.state.renderBlockedUserSnackBar === false ?
//                         <form className="chat-input-form" onSubmit={this.handleSubmit}>
//                             <div className="chat-input-text-area">
//                                 <div className="chat-input-text-area-scroller chat-input-tsa-webkit-scroll">
//                                     <div className="inner-attach-button">
...
//                                 </div>
//                             </div>
//                         </form> : <BlockedUserSnackBarContainer dmServer={this.props.dmServer} />
//                 } */}
