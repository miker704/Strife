...
//         console.log('%cinside comp MOUNT', "color:#00ff00")
...
//         console.log('%cinside comp UN MOUNT', "color:#800000")
...
//     unsubscribe () {
//         console.log('%cinside THE UNSUBSCRIBE FUNCTION ', "color:#800000")
...
//             console.log('%cinside prevProps.DmMessages[0] !== this.props.DmMessages[0]', "color:#99ff66");
//             console.log(`%cinside prevProps.DmMessages[0] == ${prevProps.DmMessages[0]} !== this.props.DmMessages[0] === ${this.props.DmMessages[0]}`, "color:#99ff66")
...
//             console.log('%cinside prevState.DmMessages.length < this.state.DmMessages.length', "color:#ffff00");
//             console.log(`%cinside prevState.DmMessages.length == ${prevState.DmMessages.length} < this.state.DmMessages.length === ${this.state.DmMessages.length}`, "color:#ffff00")
...
//             console.log('%cinside prevProps.dmMessagesIds.length !== this.props.dmMessagesIds.length', "color:#cc00ff");
//             console.log(`%cprevProps.dmMessagesIds.length====${prevProps.dmMessagesIds.length} !== this.props.dmMessagesIds.length===== ${this.props.dmMessagesIds.length}`, "color:#cc00ff")
...
//             console.log(`%cprevProps.dmMessagesIds.length====${prevProps.dmMessagesIds.length} >0 && this.props.dmMessagesIds.length > 0===== ${this.props.dmMessagesIds.length}`, "color:#ff944d")
...
//                 console.log(`%cprevProps.DmMessages[0].id====${prevProps.DmMessages[0].id} !== this.props.DmMessages[0].id ===== ${this.props.DmMessages[0].id}`, "color:#ff6600")
...
//             console.log(`%cprevProps.match.params.dmServerId ====${prevProps.match.params.dmServerId} !== this.props.match.params.dmServerId ===== ${this.props.match.params.dmServerId}`, "color:#ff0000")
