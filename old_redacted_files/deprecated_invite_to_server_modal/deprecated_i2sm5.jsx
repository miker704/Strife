...
//             }, (error) => {
//                 //default to redux call
//                 console.log("failed defaulting to redux call");
...
//             .then(res => {
//                 console.log('dmservers');
//                 setDmServers(res);

//             }, (error) => {
//                 //if fetch fails run dispatch instead
//                 props.fetchDmServers(props.currentUser.id);
//                 setDmServers(props.dmServers);
//             })
...
//     else if (props.friends.length > 0 || noFriendsToInvite === false) {
...
//                                         searchItUp(filterOutFriends).length === 0 ?
//                                             (
//                                                 <div className={`i2sm-no-results global-scroll-thin-raw-attributes global-scroller-base`} style={{ overflow: `hidden scroll`, paddingRight: `8px` }}>
//                                                     <div className="i2sm-no-results-inner">
...
//                                                     {searchItUp(filterOutFriends).map((friend) => {
//                                                         return (
