...
//                     <NavLink
//                         // to={`/$/channels/${server.id}/${server.general_channel_id}`}
//                         to={`/$/channels/${server.id}/`}
//                         onClick={() => props.fetchServer(server.id).then((action) => { props.history.push(`/$/channels/${action.server.id}/${action.server.general_channel_id}`) })}
//                         // className={serverNavBarClassTag}
//                         className={isActive => isActive ? "selected-Server" : "unselected-Server"}
