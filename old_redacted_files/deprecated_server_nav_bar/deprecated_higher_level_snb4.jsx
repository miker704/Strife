...
//                                     <svg width="48" height="48" viewBox="0 0 48 48" className="purple-bubbles" overflow="visible">

//                                         {/* {
//                                             server.server_Icon === undefined ? (
//                                                 <>
//                                                     <defs>
//                                                         <path id="server-bubble-blob-def-path" d="M48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24Z">
//                                                         </path>
//                                                     </defs>
...
//                                                         <div className="bubble-wrap" role="treeitem">
//                                                             <div className="server-Acryo" aria-hidden="true">{splitServerName(server.server_name)}</div>
...
//                                                     <div className="bubble-wrap" role="treeitem">
//                                                         <img className="bubble-img" src={server.server_Icon} alt=" " />
//                                                     </div>
//                                                 </foreignObject>
//                                             )
//                                         } */}
