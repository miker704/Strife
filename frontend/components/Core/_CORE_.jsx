...
import MessageRequestsPageContainer from "../message_requests/message_requests_page/message_requests_page_container.js";
                                ...
                                <div className="app-layer-main app-layer-main-sub">
                                    <div className="app-layer-container baselayerClear" id='app-puller'>
                                        <div className='container-mapper'>
                                            <ProtectedRoute path={['/$/$T0R3/', '/$/$H0P/', "/$/guild-discovery/", '/$/m3$$@g3-r3qu3$t$/', "/$/channels/:serverId/"]} component={ServerNavBarContainer} />
                                            ...
                                            <Switch>
                                                ...
                                                <ProtectedRoute path='/$/m3$$@g3-r3qu3$t$/' component={MessageRequestsPageContainer} />
