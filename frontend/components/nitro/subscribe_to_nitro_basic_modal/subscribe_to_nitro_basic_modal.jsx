...
import { AngelListIcon, ChatPresentIcon, CloseXIcon, FolderIcon, GitHubIcon, Invite2ServerCheckBoxCheckedIcon, Invite2ServerCheckBoxUnCheckedIcon, LinkedInIcon, NitroBasicBannerIcon, ProfilePanelChevronIcon, RoundedCheckBoxCheckedIcon, RoundedCheckBoxUnCheckedIcon, StrifeBannerLogo, WumpusIcon, } from "../../front_end_svgs/Strife_svgs";
import { useEffect, useRef, useState } from "react";
import REACT_PORTAL from "../../../utils/ReactPortal_api_util";
import { Tooltip } from "react-tooltip";

const SubscribeToStrifeNitroBasicModal = (props) => {
    ...
    let slide4 = spinCubes === false && currentSlide === 4 && gifted === false ? (
        <div className="stsm-review-step">
            <h1 className="stsnm-payment-review-header">Get $TR!F3 N!TR0 Basic {`${choosePlanType === 1 ? `Yearly` : `Monthly`}`}</h1>
            <div className="sbm-review-table stsm-invoice-step">
                ...
                <div className="sbm-rt-row sbm-rt-row-base">
                    <div className="sbm-rt-row-label">$TR!F3 N!TR0 Basic {`${choosePlanType === 1 ? `Yearly` : `Monthly`}`}</div>
        ...
        <div className="stsm-review-step">
            ...
            <div className="sbm-review-table stsm-invoice-step">
                <div className="sbm-rt-row sbm-rt-row-base stsm-gift-subscription-row">
                    <div className="sbm-rt-row-label">Gift $TR!F3 N!TR0 Basic {`${choosePlanType === 1 ? `Yearly` : `Monthly`}`}</div>
    ...
    let buttonStyles = {
        "1": `${switchMod === 3 ? `sbm-button-footer-container sbm-payment-button-footer-layout` : `sbm-button-footer-container`}`,
                        ...
                        <div className="server-boost-modal-focus-lock" onClick={(e) => e.stopPropagation()}>
                            <div className="server-boost-modal root-with-header" id="server-boost-modal">
                                <div className="stsnm-header stsnm-header-background">
                                    <div className="stsnm-HeaderBackground stsnm-tier1HeaderBackground stsnm-BGHeader stsnm-gradient-transfer">
                                        <div className="stsnm-HeaderAnimation stsnm-tier2HeaderAnimation">
                                            <div className="stsnm-panningAnimation-basic">
                                                <div className="stsnm-tier1Background panningAnimation-inner stsnm-top-animate stsnm-desaturate"></div>
                                                <div className="stsnm-tier1Background panningAnimation-inner stsnm-bottom-animate stsnm-desaturate"></div>
                                            </div>
                                            <div className="stsnm-panningAnimation-basic">
                                                <div className="stsnm-tier1Foreground panningAnimation-inner stsnm-bottom-animate stsnm-desaturate"></div>
                                                <div className="stsnm-tier1Foreground panningAnimation-inner stsnm-top-animate stsnm-desaturate"></div>
                                            </div>
                                            <div className="stsnm-sequencedAnimation">
                                                <img className="stsnm-tier1-motor-wheel-wumpus-gif" alt=" " />
                                            </div>
                                        </div>
                                        <div className="stsnm-middle-header-container">
                                            <div>
                                                <NitroBasicBannerIcon className="stsnm-banner-header-icon" />
                                            </div>
                                            ...
                                            currentSlide === 4 ? (
                                                <>
                                                    <button type="button" className="npsm-upgrade-to-nitro-button" disabled={gifted ? false : agreementCheck ? false : true}
                                                        ...
                                                        <div className="look-filled-button-contents global-button-contents">
                                                            {`${gifted ? `Buy Gift` : choosePlanType === 1 ? `Get $TR!F3 N!TR0 Basic Yearly` : `Get $TR!F3 N!TR0 Basic Monthly`}`}
                                                        </div>
                                                    </button>
                                                    <div className="stsnm-back-button-wrapper">
...
export default SubscribeToStrifeNitroBasicModal;