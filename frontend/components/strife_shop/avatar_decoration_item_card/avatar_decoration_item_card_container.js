...
import AvatarDecorationItemCard from "./avatar_decoration_item_card";
...
const AvatarDecorationItemCardContainer = withRouter(connect(mSTP, mDTP)(AvatarDecorationItemCard));
export default AvatarDecorationItemCardContainer;