...
class DmNavBar extends React.Component {
    ...
    //                 {/* 
    //                 <br /> */}
    //                 <div className='dm-server-nav-bar-dm-title'>
    ...
    //                         ) : ("");
    //                         return (
    //                             // <li className={`dmsnb-container ${selectedDmServer}`} key={dmServerIndex}>
    //                             //     <div className='inner-dms'>
    //                             //         <Link to={`/$/channels/@me/${dmServer.id}`}
    //                             //             className={`inner-dms-link ${selectedDmServer}`}
    //                             //             onClick={() => {
    ...
    //                             //             key={dmServer.id}
    //                             //         >
    //                             //             <div className='inner-dms-member-info'>
    //                             //                 <div className='dm-server-pfp'>
    //                             //                     {dmServerPFP}
    //                             //                     {onlineStatus}
    //                             //                 </div>
    //                             //                 <div className='dm-server-name-wrapper'>
    //                             //                     <div className='dmsnb-dmsm-name-inner'>
    //                             //                         <div className='dmsnb-dmsm-name-cont'>
    //                             //                             <h5 className='dm-server-name'>{dmServerName}</h5>
    //                             //                         </div>

    //                             //                     </div>
    //                             //                     <div className='dmsnb-subtext-cont'>
...
//                     <div data-tip data-for="create-dm-tool-tip" className="create-channel-div" onClick={() => this.setShowPopUp()}>
//                         <svg x="0" y="0" aria-hidden="true" className="dm-add-button" role="img" width="24" height="24" viewBox="0 0 18 18">
//                             <polygon fillRule="nonzero" fill="currentColor" points="15 10 10 10 10 15 8 15 8 10 3 10 3 8 8 8 8 3 10 3 10 8 15 8"></polygon>
//                         </svg>
