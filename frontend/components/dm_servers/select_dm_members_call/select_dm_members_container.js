...
const mSTP = (state, ownProps) => {
    let dmMembers = [];
    if (state.entities.dmServers[ownProps.compParams.dmServerId]) {
        dmMembers = state.entities.dmServers[ownProps.compParams.dmServerId].members;
    }
    return {
        currentUser: state.currentUser,
        currentUserId: state.session.id,
        dmServers: Object.values(state.entities.dmServers),
        dmServer: state.entities.dmServers[ownProps.compParams.dmServerId],
