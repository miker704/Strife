...
const CreateDmModalHomeBar = (props) => {
    ...
    const handleESC = (e) => {
        const keys = {
            27: () => {
                e.preventDefault();
                props.setCreateDMModalHBV(false);
                window.removeEventListener('keyup', handleESC, false);
            },
        };
        if (keys[e.keyCode]) {
    ...
    if (isLoading === false && props.friends.length > 0) {
        return (
            <REACT_PORTAL wrapperId={'sub-modal'} classNameId={'subModal'} onClick={(e) => e.stopPropagation()}>
                <div className={`clear-modal-wrapper homeBar`} onClick={(e) => props.setCreateDMModalHBV(false)}>
                                    ...
                                    </div>
                                    {
                                        ...
                                        isFullyLoaded === true ?
                                            (
                                                ...
                                                _liveSearch(props.friends).length === 0 ?
                                                    (
                                                        <div className="create-dm-no-results">
                                                    ...
                                                    (
                                                        <div className="create-dm-scroller global-scroll-thin-raw-attributes global-scroller-base global-scroll-faded-raw-attributes" id='ul-fiiw' style={{ overflow: `hidden scroll`, paddingRight: `0px` }}>
                                                            <div className="create-dm-ul-list">
                                                                ...
                                                                {
                                                                    _liveSearch(props.friends).map((friend) => {
                                                                        return (
