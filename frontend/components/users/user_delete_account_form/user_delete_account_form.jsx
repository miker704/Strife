...
const DeleteUserAccountForm = (props) => {
    ...
    const submissionBlocker = (e) => {
        ...
        if (document.getElementById("rpn-pwi").value === "" || document.getElementById("rpn-pwi").value === null) {
            document.getElementById("delete-submit-button").disabled = true;
        }
        else {
            document.getElementById("delete-submit-button").disabled = false;
        }
    }
    ...
    const handleSubmit = (e) => {
        ...
        props.disableUserAccount(subState).then(() => {
            props.closeModal();
            props.logoutUser();
            props.removeUserAccount(props.currentUser.id);
        })
    }
                            ...
                            <div className='user-sub-modal' id="user-sub-modal" ref={popUpRef} onClick={(e) => e.stopPropagation()}>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className='user-sub-modal-header-container-remove-phone-number' style={{ flex: `0 0 auto` }}>
                                        <h1 className='user-sub-modal-acc-rmv-header'>Delete Account</h1>
                                    </div>
                                    ...
                                    <div className='user-sub-modal-button-footer-container'>
                                        <button id="delete-submit-button" type='submit' className='user-sub-modal-submit-button' disabled>
                                            <div id="submit-button-text" className='look-filled-button-contents global-button-contents'>Delete Account</div>
                                        </button>
